					...
					<div class="au-breadcrumb-content">
						<div class="au-breadcrumb-left">
							...
							<ul class="list-unstyled list-inline au-breadcrumb__list">
								...
								<li class="list-inline-item">Thêm vai trò</li>
							</ul>
						</div>
					</div>
				</div>
...
<div class="main-content">
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><strong>Thêm </strong> vai trò</div>
						...
						<form action="{{ route('roles.store') }}" method="post" enctype="multipart/form-data">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-9">
									<input type="text" id="hf-email" name="name" placeholder="Tên slider" class="form-control" value="{{old('name')}}" />
								</div>
							</div>
							<div class="row form-group">
								<div class="col col-md-3">
								...
								<div class="col-12 col-md-9">
									<textarea name="display_name" class="form-control" rows="7">{{old('display_name')}}</textarea>
								</div>
							</div>
							<div class="col-12">
